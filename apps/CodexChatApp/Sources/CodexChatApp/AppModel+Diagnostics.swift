    ...
    func copyDiagnosticsBundle() {
        do {
            let snapshot = DiagnosticsBundleSnapshot(
                ...
                activeCodexHomePath: resolvedCodexHomes.activeCodexHomeURL.path,
                activeAgentsHomePath: resolvedCodexHomes.activeAgentsHomeURL.path,
                activeCodexHomeSource: resolvedCodexHomes.source.rawValue,
                legacyManagedCodexHomePath: storagePaths.legacyManagedCodexHomeURL.path,
                legacyManagedAgentsHomePath: storagePaths.legacyManagedAgentsHomeURL.path,
                sharedCodexHomeHandoffReportPath: storagePaths.sharedCodexHomeHandoffReportURL.path,
                legacyManagedHomesArchivePath: lastLegacyManagedHomesArchivePath,
