    ...
    var body: some View {
        ...
        .sheet(isPresented: $model.isDiagnosticsVisible) {
            DiagnosticsView(
                ...
                approvalStatusMessage: model.approvalStatusMessage,
                serverRequestStatusMessage: model.serverRequestStatusMessage,
                pendingRuntimeRequests: model.pendingRuntimeRequestSupportSummaries(),
                runtimeRequestSupportEvents: model.runtimeRequestSupportEvents,
                logs: model.logs,
