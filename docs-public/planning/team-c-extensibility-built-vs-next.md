...
- Next step is unified automation timeline UX and policy-aware retry telemetry across launchd + scheduler streams.
...
### 0-30 days
1. Add policy-gated direct rerun execution contracts keyed by diagnostics category, with strict allowlists and explicit approval prompts.
...
### 61-90 days
1. Complete policy-aware diagnostics/remediation action plumbing across skills/mods/extensions.
